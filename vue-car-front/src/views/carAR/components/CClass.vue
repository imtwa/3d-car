...
const getThreeJs = async () => {
    ...
    new GLTFLoader().load(modelUrl.value, function (gltf) {
        ...
        carModel.traverse((obj) => {//遍历模型树结构，查询模型节点
            ...
            if (obj.name == '网格' || obj.name == '网格008' || obj.name == '网格001'
                || obj.name == '网格002' || obj.name == '网格003' || obj.name == '网格004'
                || obj.name == '网格006' || obj.name == '网格014') {
                obj.material = bodyMaterial
            }
            else if (obj.name == '网格_2' || obj.name == '网格_3') {
                obj.material = carbonMaterial
            }
            else if (obj.name == '网格_4' || obj.name == '网格001_3'
                || obj.name == '网格004_3' || obj.name == '网格002_2'
                || obj.name == '网格003_3' || obj.name == '网格014_13') {
    ...
    //车内第一视角
    function carFirstIn() {
        setAnimationCamera({ cx: 2.25, cy: 1.4, cz: 4, ox: 0, oy: 0.5, oz: 0 }, { cx: 0, cy: 1, cz: -0.35, ox: 0, oy: 0.5, oz: 3 });
    }
    //车内第二视角
    function carSecondIn() {
        setAnimationCamera({ cx: 2.25, cy: 1.4, cz: 4, ox: 0, oy: 0.5, oz: 0 }, { cx: 0, cy: 1, cz: -1.3, ox: 0, oy: 0.5, oz: 3 });
    }
    //车外视角
    function carOut() {
        setAnimationCamera({ cx: 0, cy: 1, cz: -0.35, ox: 0, oy: 0.5, oz: 3 }, { cx: 2.25, cy: 1.4, cz: 4, ox: 0, oy: 0.5, oz: 0 });
    }
