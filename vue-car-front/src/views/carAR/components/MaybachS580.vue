...
const getThreeJs = async () => {
    ...
    new GLTFLoader().load(modelUrl.value, function (gltf) {
        ...
        carModel.traverse((obj) => {//遍历模型树结构，查询模型节点
            ...
            if (obj.name == '網格006_3'
                || obj.name == '網格005' || obj.name == '網格003'
                || obj.name == '網格004' || obj.name == '網格007' || obj.name == '網格006_1') {
                obj.material = bodyMaterial
            }
            else if (obj.name == '網格006_20' || obj.name == '網格005_8'
                || obj.name == '網格003_4' || obj.name == '網格004_7' || obj.name == '網格007_4') {
                obj.material = chromeMaterial
            }
            else if (obj.name == 'Aow_Benz_003' || obj.name == 'Aow_Benz_005') {
                leftdoors.push(obj)
                console.log(leftdoors)
            }
            else if (obj.name == 'Aow_Benz_004' || obj.name == 'Aow_Benz_01') {
                rightdoors.push(obj)
    ...
    //车内第一视角
    function carFirstIn() {
        setAnimationCamera({ cx: 2.25, cy: 1.4, cz: 4, ox: 0, oy: 0.5, oz: 0 }, { cx: 0, cy: 0.95, cz: 0.45, ox: 0, oy: 0.5, oz: 3 });
    }
    //车内第二视角
    function carSecondIn() {
        setAnimationCamera({ cx: 2.25, cy: 1.4, cz: 4, ox: 0, oy: 0.5, oz: 0 }, { cx: 0, cy: 1.2, cz: -0.7, ox: 0, oy: 0.5, oz: 3 });
    }
    //车外视角
    function carOut() {
        setAnimationCamera({ cx: 0, cy: 0.95, cz: 0.45, ox: 0, oy: 0.5, oz: 3 }, { cx: 2.25, cy: 1.4, cz: 4, ox: 0, oy: 0.5, oz: 0 });
    }
