...
const getThreeJs = async () => {
    ...
    new GLTFLoader().load(modelUrl.value, function (gltf) {
        ...
        carModel.traverse((obj) => {//遍历模型树结构，查询模型节点
            ...
            if (obj.name == '网格' || obj.name == '网格010' || obj.name == '网格002'
                || obj.name == '网格003' || obj.name == '网格007' || obj.name == '网格012'
                || obj.name == '网格008') {
                obj.material = bodyMaterial
            }
            else if (obj.name == '网格009' || obj.name == '网格_1'
                || obj.name == '网格002_1' || obj.name == '网格012_1'
                || obj.name == '网格007_1' || obj.name == '网格003_1'
            ) {
                obj.material = carbonMaterial
            }
            else if (obj.name == '网格010_3' || obj.name == '网格008_3'
                || obj.name == '网格_3' || obj.name == '网格002_2'
                || obj.name == '网格012_2' || obj.name == '网格007_2' || obj.name == '网格003_2') {
    ...
    //车内第一视角
    function carFirstIn() {
        setAnimationCamera({ cx: 2.25, cy: 1.4, cz: 4, ox: 0, oy: 0.5, oz: 0 }, { cx: 0, cy: 1.6, cz: -0.3, ox: 0, oy: 0.5, oz: 3 });
    }
    //车内第二视角
    function carSecondIn() {
        setAnimationCamera({ cx: 2.25, cy: 1.4, cz: 4, ox: 0, oy: 0.5, oz: 0 }, { cx: 0, cy: 1.6, cz: -1.3, ox: 0, oy: 0.5, oz: 3 });
    }
    //车外视角
    function carOut() {
        setAnimationCamera({ cx: 0, cy: 1.6, cz: -0.3, ox: 0, oy: 0.5, oz: 3 }, { cx: 2.25, cy: 1.4, cz: 4, ox: 0, oy: 0.5, oz: 0 });
    }
