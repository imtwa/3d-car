...
const getThreeJs = async () => {
    ...
    new GLTFLoader().load(modelUrl.value, function (gltf) {
        ...
        carModel.traverse((obj) => {//遍历模型树结构，查询模型节点
            ...
            else if (obj.name == '网格_2' || obj.name == '网格005_21' || obj.name == '网格007_20') {
                obj.material = carbonMaterial
            }
            else if (obj.name == '网格_4' || obj.name == '网格_5'
                || obj.name == '网格014_4' || obj.name == '网格007_3' || obj.name == '网格003_3'
                || obj.name == '网格001_3' || obj.name == '网格005_3' || obj.name == '网格023_1' || obj.name == '网格019_1'
                || obj.name == '网格021_1' || obj.name == '网格018_1') {
