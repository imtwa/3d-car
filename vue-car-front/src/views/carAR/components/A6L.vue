...
const getThreeJs = async () => {
  ...
  new GLTFLoader().load(modelUrl.value, function (gltf) {
    ...
    carModel.traverse((obj) => {//遍历模型树结构，查询模型节点
      ...
      if (obj.name == '網格' || obj.name == '網格002'
        || obj.name == '網格002_2' || obj.name == '網格001' || obj.name == '網格001_2'
        || obj.name == '網格004' || obj.name == '網格003' || obj.name == '網格012') {
        obj.material = bodyMaterial
      }
      else if (obj.name == '網格012_2') {
        obj.material = carbonMaterial
      }
      else if (obj.name == '網格012_1' || obj.name == '網格002_1' || obj.name == '網格004_1'
        || obj.name == '網格_1' || obj.name == '網格001_1' || obj.name == '網格003_1'
        || obj.name == '網格010' || obj.name == '網格012_8') {
  ...
  //车内第一视角
  function carFirstIn() {
    setAnimationCamera({ cx: 2.25, cy: 1.4, cz: 4, ox: 0, oy: 0.5, oz: 0 }, { cx: 0, cy: 0.9, cz: -0.1, ox: 0, oy: 0.5, oz: 3 });
  }
  //车内第二视角
  function carSecondIn() {
    setAnimationCamera({ cx: 2.25, cy: 1.4, cz: 4, ox: 0, oy: 0.5, oz: 0 }, { cx: 0, cy: 1.2, cz: -1, ox: 0, oy: 0.5, oz: 3 });
  }
  //车外视角
  function carOut() {
